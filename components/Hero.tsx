          ...
          >
            ...
            >
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:from-blue-700 hover:to-purple-700 cursor-pointer"
              >
                <Download size={20} />
                Download CV
              </motion.a>
              <motion.button 
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="border-2 border-purple-500 text-white px-8 py-4 rounded-xl font-semibold flex items-center justify-center gap-3 hover:bg-purple-500/20 transition-all duration-300 backdrop-blur-sm"
              >
                <Mail size={20} />
                Hire Me
              </motion.button>
            ...
            >
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="w-12 h-12 bg-gradient-to-r from-gray-800 to-gray-700 rounded-full flex items-center justify-center text-white hover:text-blue-400 transition-all duration-300 shadow-lg hover:shadow-xl"
                  style={{
            ...
            <div className="relative">
              ...
              <div className="relative w-80 h-80 lg:w-96 lg:h-96">
                ...
                <div className="relative w-full h-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 rounded-full flex items-center justify-center shadow-2xl">
                  ...
                  <div className="relative w-72 h-72 lg:w-88 lg:h-88 bg-black rounded-full flex items-center justify-center overflow-hidden shadow-inner">
              ...
              <motion.div
                ...
                className="absolute -top-6 -right-6 w-14 h-14 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute -bottom-6 -left-6 w-14 h-14 bg-gradient-to-r from-green-500 to-blue-600 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute top-1/2 -right-8 w-12 h-12 bg-gradient-to-r from-red-500 to-orange-500 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute -top-8 -left-8 w-12 h-12 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute top-1/4 -left-12 w-11 h-11 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute bottom-1/4 -right-12 w-11 h-11 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute top-3/4 -right-10 w-10 h-10 bg-gradient-to-r from-green-600 to-emerald-500 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute -bottom-8 -right-8 w-11 h-11 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute top-1/3 -left-10 w-10 h-10 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute bottom-1/3 -left-8 w-10 h-10 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute bottom-1/6 -left-10 w-9 h-9 bg-gradient-to-r from-violet-500 to-purple-600 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute top-1/5 -right-16 w-10 h-10 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute bottom-1/4 -right-14 w-9 h-9 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full flex items-center justify-center shadow-lg"
              >
              ...
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.8 }}
                className="absolute -bottom-18 left-1/4 transform -translate-x-1/2 text-center"
              >
                <h3 className="text-white text-xl lg:text-2xl font-bold mb-2 drop-shadow-lg">
                  Mostafa Elgazar
                </h3>
                <div className="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent text-md font-semibold">
